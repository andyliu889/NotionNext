...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 布担巴网', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '科技布担巴网博主 欢迎关注', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'http://www.budanba.com', // 网站地址
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '', // 备案号 豫ICP备16010761号
